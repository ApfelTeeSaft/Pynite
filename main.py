...
def fortnitegameresponse():
    ...
    if s1builds in current_season:
        ...
        return fortnitegame()
    elif s7builds in current_season:
        #replace with ch1 s7 response
        return fortnitegame()
    elif s8builds in current_season:
        #replace with ch1 s8 response
        return fortnitegame()
    elif s9builds in current_season:
        #replace with ch1 s9 response
        return fortnitegame()
    elif s10builds in current_season:
        #replace with ch1 s10 response
        return fortnitegame()
